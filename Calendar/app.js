...
const generateCalendar = (month,year) =>{
    ...
    for (let i = 0 ; i <= days_of_months[month] + first_day.getDay()-1; i++){
...
//     month_list.classList.add("hideonce");
// })();
document.querySelector("#pre-year").addEventListener("click" , (e)=>{
    --currentYear.value ;
    generateCalendar(currentMonth.value , currentYear.value)
})
...
let currentYear = {value : currentDate.getUTCFullYear()};
generateCalendar(currentMonth.value ,currentYear.value);

const todayShowTime = document.querySelector(".time-formate");
const todyShowDate = document.querySelector(".date-formate");
...
todyShowDate.textContent = currentDateFormate;
setInterval(()=>{
